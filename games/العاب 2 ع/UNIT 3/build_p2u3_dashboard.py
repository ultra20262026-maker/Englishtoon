...
<head>
    ...
    <title>الصف الثاني الإعدادي - الوحدة الثالثة (Facing Challenges)</title>
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Outfit', 'Cairo', sans-serif; }}
        ...
        .header-container {{
            ...
            border: 2px solid rgba(16, 185, 129, 0.3); box-shadow: 0 20px 50px rgba(0,0,0,0.5);
            backdrop-filter: blur(10px); width: 100%; max-width: 800px;
        }}
        @keyframes slideDown {{ from {{ transform: translateY(-50px); opacity: 0; }} to {{ transform: translateY(0); opacity: 1; }} }}

        .main-title {{ font-size: 3.5rem; font-weight: 900; color: #10B981; margin-bottom: 0.5rem; text-shadow: 0 0 20px rgba(16, 185, 129, 0.5); }}
        ...
        .game-card:hover {{
            ...
            border-color: #10B981; box-shadow: 0 15px 30px rgba(16, 185, 129, 0.2);
        ...
        .game-card:hover .game-icon {{ transform: scale(1.1); filter: drop-shadow(0 0 15px rgba(16, 185, 129, 0.5)); }}
        ...
        .play-btn {{
            margin-top: 1.5rem; background: transparent; border: 2px solid #10B981; color: #10B981;
            padding: 0.8rem 2rem; font-size: 1.2rem; font-weight: 700; border-radius: 1rem;
            transition: all 0.3s ease; text-decoration: none; display: inline-block;
        }}
        .game-card:hover .play-btn {{ background: #10B981; color: #0F172A; box-shadow: 0 0 15px rgba(16, 185, 129, 0.5); }}
...
<body>
    ...
    <div class="header-container">
        <h1 class="main-title">الوحدة الثالثة</h1>
        <p class="subtitle">Facing Challenges (مواجهة التحديات)</p>
    </div>

    <div class="grid-container">
        <!-- Game 1 -->
        <a href="unit3_game_lesson1.html" style="text-decoration:none; color:inherit;">
            <div class="game-card">
                <div class="game-icon">⛰️</div>
                <div>
                    <h2 class="game-title">الدرس الأول</h2>
                    <p class="game-desc">تسلق الجبل للوصول للقمة!</p>
                </div>
        ...
        <!-- Game 2 -->
        <a href="unit3_game_lesson2.html" style="text-decoration:none; color:inherit;">
            <div class="game-card">
                <div class="game-icon">🏃‍♂️</div>
                <div>
                    <h2 class="game-title">الدرس الثاني</h2>
                    <p class="game-desc">سباق الحواجز لاختبار السرعة.</p>
                </div>
                <div class="play-btn">ابدأ اللعب</div>
            </div>
        </a>
        ...
        <!-- Game 3 -->
        <a href="unit3_game_lesson3.html" style="text-decoration:none; color:inherit;">
            <div class="game-card">
                <div class="game-icon">🏗️</div>
                <div>
                    <h2 class="game-title">الدرس الثالث</h2>
                    <p class="game-desc">باني المستقبل وناطحات السحاب.</p>
                </div>
                <div class="play-btn">ابدأ اللعب</div>
            </div>
        </a>
        ...
        <!-- Game 4 -->
        <a href="unit3_game_lesson4.html" style="text-decoration:none; color:inherit;">
            <div class="game-card">
                <div class="game-icon">🌊</div>
                <div>
                    <h2 class="game-title">الدرس الرابع</h2>
                    <p class="game-desc">غواص الأعماق واستكشاف المحيط.</p>
                </div>
                <div class="play-btn">ابدأ اللعب</div>
            </div>
        </a>
        ...
        <!-- Game 5 & 6 -->
        <a href="unit3_game_lesson5_6.html" style="text-decoration:none; color:inherit;">
            <div class="game-card">
                <div class="game-icon">🚀</div>
                <div>
                    <h2 class="game-title">الدرس 5 و 6</h2>
                    <p class="game-desc">مهمة الفضاء والإقلاع.</p>
                </div>
                <div class="play-btn">ابدأ اللعب</div>
            </div>
        </a>
        ...
        <!-- Final Review -->
        <a href="unit3_review.html" style="text-decoration:none; color:inherit;">
            <div class="game-card review-card">
                <div class="game-icon">🏆</div>
                <div>
                    <h2 class="game-title">تحدي الكأس</h2>
                    <p class="game-desc">المراجعة النهائية للوحدة الثالثة.</p>
                </div>
...
with open(os.path.join(target_dir, "unit3_dashboard.html"), "w", encoding="utf-8") as f:
    f.write(html_content)

print("Unit 3 Dashboard generated successfully.")
