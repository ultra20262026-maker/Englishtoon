...
bg_path = get_latest_image("ocean_depth_bg", brain_dir)
sub_path = get_latest_image("submarine_prop", brain_dir)
...
<head>
    ...
    <title>الدرس الرابع - غواص الأعماق</title>
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Outfit', 'Cairo', sans-serif; }}
        ...
        body::before {{
            ...
            background: rgba(2, 6, 23, 0.6); z-index: 1; backdrop-filter: blur(2px);
        }}
        ...
        .ocean-layer {{
            ...
            background: linear-gradient(180deg, rgba(6,182,212,0.2) 0%, rgba(2,6,23,0.9) 100%);
            border-radius: 10px;
        }}
        ...
        .submarine {{
            ...
            background-image: url('{sub_b64}'); background-size: contain; background-repeat: no-repeat;
            background-position: center; transition: top 1s ease-in-out; z-index: 5;
        ...
        .treasure {{
            position: absolute; bottom: 5%; left: 50%; transform: translateX(-50%); font-size: 4rem;
            filter: drop-shadow(0 0 20px rgba(234,179,8,0.8)); opacity: 0; transition: opacity 1s;
        }}
...
<body>
    ...
    <div class="layout-container">
        <div class="left-col">
            <div class="header" id="game-header" style="display: none;">
                <h1 class="game-title">غواص الأعماق 🌊</h1>
                <div class="stats">
            ...
            <button class="start-btn" id="start-btn" onclick="startGame()">ابدأ الغوص!</button>
    ...
    <script>
        ...
        function playDive() {{ playTone(500, 300, 'sine', 0.8, 0.4); }}
        ...
        const questions = [
            {{ q: "I am sure he .......... pass the exam.", options: ["will", "going to", "goes", "did"], correct: 0 }},
            {{ q: "Diving deep into the ocean is a great .......... .", options: ["boring", "challenge", "food", "toy"], correct: 1 }},
            {{ q: "They are .......... to travel to Alexandria tomorrow.", options: ["will", "go", "going", "went"], correct: 2 }},
            {{ q: "We must protect the ocean's .......... .", options: ["cars", "environment", "buildings", "streets"], correct: 1 }},
            {{ q: "A submarine can go deep under the .......... .", options: ["sky", "desert", "water", "space"], correct: 2 }},
            {{ q: "I think people .......... live on the moon one day.", options: ["will", "going to", "does", "did"], correct: 0 }},
            {{ q: "Overcoming a challenge makes you .......... .", options: ["weak", "sad", "stronger", "angry"], correct: 2 }},
            {{ q: "She .......... going to visit her grandparents this weekend.", options: ["am", "is", "are", "will"], correct: 1 }},
            {{ q: "Exploring the deep sea helps us .......... new things.", options: ["lose", "forget", "discover", "break"], correct: 2 }},
            {{ q: "Are you .......... to join the new club?", options: ["go", "going", "will", "went"], correct: 1 }}
        ];
        ...
        let diveProgress = 10; // start at top 10%

        function updatePosition() {{
            const player = document.getElementById('player');
            player.style.top = `${{diveProgress}}%`;
            
            if(currentIndex >= 9) {{
                document.getElementById('treasure').style.opacity = '1';
            }}
        }}
        ...
        function updateTimer() {{
            ...
            if (timeRemaining <= 0) {{
                ...
                playHit();
                handleFail("انتهى الوقت! ⚠️ فقدت السيطرة على الغواصة!");
            }} else {{
        ...
        function selectOption(idx) {{
            ...
            if (idx === correctIdx) {{
                ...
                currentIndex++;
                diveProgress += 7; // Max ~73%
                
                updatePosition();
                playDive();
                
                setTimeout(() => {{
                    showAlert(true, "إجابة صحيحة! غصنا أعمق 🌊");
                }}, 800);
            }} else {{
                btns[idx].classList.add('wrong');
                btns[correctIdx].classList.add('correct');
                playHit();
                setTimeout(() => handleFail("إجابة خاطئة! ❌ ارتطمت الغواصة بصخرة!"), 1000);
            }}
        }}
        ...
        function nextQuestion() {{
            ...
            if (lives <= 0) {{ 
                currentIndex = 0; lives = 3; diveProgress = 10;
                updatePosition();
            }}
            renderQuestion();
        }}
        ...
        function showGameOver() {{
            ...
            qBox.innerHTML = `
                ...
                <div class="question-text" style="color: white; text-align:center;">تهانينا! لقد تغلبت على ضغط الأعماق ووصلت للكنز المفقود! 🎉</div>
...
with open(os.path.join(target_dir, "unit3_game_lesson4.html"), "w", encoding="utf-8") as f:
    f.write(html_content)

print("Game 4 for Unit 3 generated successfully.")
