...
bg_path = get_latest_image("privacy_shield_bg", brain_dir)
...
<head>
    ...
    <title>الدرس الثالث - درع الخصوصية</title>
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Outfit', 'Cairo', sans-serif; }}
        ...
        .answer-btn:hover {{ background: rgba(168, 85, 247, 0.2); border-color: #A855F7; transform: translateY(-3px); }}
        ...
        /* Shield System */
        .shield-core {{
            width: 80px; height: 80px; background: #06B6D4; border-radius: 50%;
            position: relative; z-index: 2; box-shadow: 0 0 30px #06B6D4;
        ...
        .shield-layer {{
            ...
            opacity: 0; box-shadow: inset 0 0 20px transparent;
        }}
...
<body>
    ...
    <div class="layout-container">
        <div class="left-col">
            <div class="header" id="game-header" style="display: none;">
                <h1 class="game-title">درع الخصوصية 🛡️</h1>
                <div class="stats">
        ...
        <div class="right-col" id="shield-section" style="display: none;">
            <!-- Layers generated by JS -->
            <div class="shield-core" id="shield-core">🔒</div>
        </div>
    </div>
    ...
    <script>
        ...
        function playShield() {{ playTone(800, 1600, 'sine', 0.4, 0.3); }}
        ...
        const questions = [
            {{ q: "Which of the following is personal information?", options: ["Your favorite color", "Your home address", "A movie you like", "A song"], correct: 1 }},
            {{ q: "You should never post a photo of your .......... without asking them first.", options: ["books", "toys", "friends", "trees"], correct: 2 }},
            {{ q: "Public information is something that .......... can see.", options: ["nobody", "only you", "anyone", "hackers"], correct: 2 }},
            {{ q: "It is .......... to share your phone number with a stranger online.", options: ["dangerous", "safe", "smart", "good"], correct: 0 }},
            {{ q: "We use privacy .......... on social media to control who sees our posts.", options: ["games", "settings", "photos", "computers"], correct: 1 }},
            {{ q: "A good digital citizen respects the .......... of others.", options: ["privacy", "money", "cars", "games"], correct: 0 }},
            {{ q: "Sharing your location online can be a .......... to your safety.", options: ["help", "risk", "benefit", "gift"], correct: 1 }},
            {{ q: "You can ask an adult for .......... if you feel unsafe online.", options: ["money", "food", "help", "clothes"], correct: 2 }},
            {{ q: "It is important to .......... before you share something online.", options: ["sleep", "eat", "run", "think"], correct: 3 }},
            {{ q: "Your school name is considered .......... information.", options: ["safe", "private", "public", "funny"], correct: 1 }}
        ];
        ...
        function initShield() {{
            ...
            for(let i=0; i<10; i++) {{
                ...
                // Add some dash array pattern to borders based on index
                if(i % 2 === 0) layer.style.borderStyle = 'dashed';
                else if(i % 3 === 0) layer.style.borderStyle = 'dotted';
        ...
        function activateLayer() {{
            const layer = document.getElementById(`layer-${{currentIndex-1}}`);
            if(layer) {{
                layer.style.opacity = 1;
                layer.style.borderColor = '#A855F7';
                layer.style.boxShadow = '0 0 10px #A855F7, inset 0 0 10px #A855F7';
                layer.style.animation = `rotate-layer ${{10 - (currentIndex*0.5)}}s linear infinite`;
                if(currentIndex % 2 === 0) layer.style.animationDirection = 'reverse';
            }}
        }}
        ...
        function startGame() {{
            ...
            document.getElementById('shield-section').style.display = 'flex';
        ...
        function updateTimer() {{
            ...
            if (timeRemaining <= 0) {{
                ...
                playWrong();
                handleFail("انتهى الوقت! ⚠️ اختراق أمني!");
            }} else {{
        ...
        function handleFail(msg) {{
            ...
            core.style.boxShadow = '0 0 50px #EF4444';
            setTimeout(() => {{
                core.style.background = '#06B6D4';
                core.style.boxShadow = '0 0 30px #06B6D4';
            }}, 500);
        ...
        function selectOption(idx) {{
            ...
            if (idx === correctIdx) {{
                ...
                setTimeout(() => {{
                    showAlert(true, "إجابة صحيحة! تم تفعيل طبقة الحماية 🛡️✨");
                }}, 800);
            }} else {{
                btns[idx].classList.add('wrong');
                btns[correctIdx].classList.add('correct');
                playWrong();
                setTimeout(() => handleFail("إجابة خاطئة! ❌ طبقة الدرع ضعفت!"), 1000);
            }}
        }}
        ...
        function showAlert(isSuccess, message) {{
            ...
            if (isSuccess) {{
                icon.innerText = '🛡️'; title.innerText = 'ممتاز!'; title.style.color = '#10B981';
            }} else {{
        ...
        function showGameOver() {{
            ...
            qBox.innerHTML = `
                ...
                <div class="question-text" style="color: white; text-align:center;">اكتمل الدرع! خصوصيتك الآن بأمان تام! 🎉</div>
...
with open(os.path.join(target_dir, "unit2_game_lesson3.html"), "w", encoding="utf-8") as f:
    f.write(html_content)

print("Game 3 for Unit 2 generated successfully.")
