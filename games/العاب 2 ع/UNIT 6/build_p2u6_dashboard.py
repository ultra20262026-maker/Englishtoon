...
thumbnails = {
    'g1': get_latest_image("earth_space_bg", brain_dir),
    'g2': get_latest_image("barren_land_bg", brain_dir),
    'g3': get_latest_image("dark_sea_bg", brain_dir),
    'g4': get_latest_image("dark_stage_bg", brain_dir),
    'g5': get_latest_image("recycling_factory_bg", brain_dir),
    'g6': get_latest_image("world_portal_bg", brain_dir),
}
...
<head>
    ...
    <title>الوحدة السادسة - Environments</title>
    <style>
        ...
        * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Outfit', 'Cairo', sans-serif; }}
        ...
        .unit-title {{
            ...
            text-shadow: 0 0 20px rgba(16,185,129,0.5); margin-bottom: 1rem;
        ...
        .lesson-num {{
            color: #10B981; font-weight: 900; font-size: 1.2rem; margin-bottom: 0.5rem;
        }}
...
with open(os.path.join(target_dir, "unit6_dashboard.html"), "w", encoding="utf-8") as f:
    f.write(html_content)

print("Unit 6 Dashboard generated successfully.")
