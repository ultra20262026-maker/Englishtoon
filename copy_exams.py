...
unit_mapping = {
    "الوحدة الأولى": 1, "Unit1": 1, "unit1": 1,
    "الوحدة الثانية": 2, "Unit2": 2, "unit2": 2,
    "الوحدة الثالثة": 3, "Unit3": 3, "unit3": 3,
    "الوحدة الرابعة": 4, "Unit4": 4, "unit4": 4,
    "الوحدة الخامسة": 5, "Unit5": 5, "unit5": 5,
    "الوحدة السادسة": 6, "Unit6": 6, "unit6": 6
}
    ...
    for unit_folder in os.listdir(grade_path):
        ...
        for file_name in os.listdir(unit_path):
            ...
            if 'review' in name.lower() or 'مراجعة' in name:
                ...
                name = name.replace('exam g4 ', '').replace('exam g5 ', '').replace('exam lesson', 'Lesson ').replace('exam', 'Exam')
